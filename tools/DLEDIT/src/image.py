...
class ImageSelector():
    ...
    def update(self, dir):
        dledit.image_dir = dir
        self.image_dir = dir
        self.log.write('ImageSelector update %s\n' % self.image_dir)
        ...
        self.index = 0
        self.log.write(str(self.image_list))
    ...
    def save_image(self, pos):
        ...
        self.log.write("save %s" % out_full_path)
    ...
    def open_label_file(self):
        ...
        self.log.write("open labal file %s" % full_path)
